...
if __name__ == "__main__":
    ...
    parser.add_argument('--qst_vocab_size', type=int, default=1000, help='Question vocabulary size')
    parser.add_argument('--ans_vocab_size', type=int, default=1000, help='Answer vocabulary size')
